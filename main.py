...
canvas.create_text(100, 130, text="00:00", fill="white", font=(FONT_NAME, FONT_SIZE, TEXT_TYPEFACE))
# canvas.pack()
...
start_button = Button(text="Start", font=("Arial", 12, "bold"), highlightthickness=0)
